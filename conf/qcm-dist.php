...
return array(
    'Himedia\QCM' => array(
        ...
        'mutt_to' => 'admin@__DOMAIN__',
        'mutt_cfg' => "set charset='utf-8'; set copy=no; set content_type=text/html; my_hdr From: Quizzes <quizzes@__DOMAIN__>; my_hdr Reply-To: Admin <admin@__DOMAIN__>",
